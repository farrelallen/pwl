  ...
  <div class="header">
    <div class="container">
      ...
      <div class="navbar d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
          <a class="font-weight-bold" href="" style="color: white;"><span class="font-weight-bold">User</span></a>
          <div class="hr1 mx-2"></div>
          <a class="font-weight-bold" href="index.php" style="color: white;"><span class="font-weight-bold">LogOut</span></a>
        </div>
      </div>
      <!-- input search brand -->
...
<div class="col-3 d-flex flex-column align-items-center">
    ...
    <a href="pesan.php" class="btn w-50" style="color: #888; border: 1px solid #888; background-color: #ffffff;">
        Pesan Disini!
    </a>
</div>
